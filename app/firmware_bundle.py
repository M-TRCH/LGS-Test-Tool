...
IMAGES: tuple = (
    BundledImage(
        ...
        note="TCP console + network fw update; schema wipe — export first",
    ),
    BundledImage(
    ...
    BundledImage(
        ...
        note="stats v2 + hub-crossing fix, over the bus",
    ),
    BundledImage(
        key="gateway_v1.10.0",
        kind=KIND_GATEWAY,
        version="v1.10.0",
        blob="gateway_opta_v1.10.0.bin",
        sha256="4d93cd92e0490c3ec07effad0c710f4bbfde9712485f8b2aa4472ac5d1d217ce",
        source="LGS-Gateway-Arduino-Opta release v1.10.0",
