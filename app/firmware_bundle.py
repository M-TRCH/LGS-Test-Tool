...
IMAGES: tuple = (
    BundledImage(
        ...
        kind=KIND_GATEWAY,
        version="v1.2.0",
        blob="gateway_opta_v1.2.0.bin",
        sha256="ecd8dd42b543d0c2aa4e9bdf0b23433f5ae93060b9a0789f777ceef3565ffc07",
        source="LGS-Gateway-Arduino-Opta release v1.2.0",
        note="RS485 switch-hub repair",
    ),
    BundledImage(
