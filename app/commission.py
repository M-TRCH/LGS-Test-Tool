...
def run_commission(ops: CommissionOps, cfg: CommissionConfig, emit, cancel
    ...
    try:
        ...
        try:
            ...
            say(str(exc), "err")
            return finish(False, "could not patch the image")
